  ...
  return useQuery<DashboardSummary>({
    ...
    queryFn: async () => {
      ...
      const todaysTasks: TaskItem[] = [
        ...
        { id: 'food', label: 'Log your meals', completed: meals.length > 0, icon: 'UtensilsCrossed', points: 20, href: '/nutrition' },
        { id: 'weight', label: 'Log today\'s weight', completed: !!weightLog, icon: 'Scale', points: 10, href: '/tracking/weight' },
        {
          id: 'sleep',
